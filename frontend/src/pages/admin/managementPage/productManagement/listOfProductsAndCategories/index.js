                                      ...
                                      >
                                        <div style={{display:"flex", justifyContent:"flex-start", alignItems:"center", width: "100%", height:"100%"}}>
                                          ...
                                          <div style={{alignSelf: "flex-start", width:"25px", minWidth:"25px",
                                            ...
                                            borderRight:`${selectedSearch !== SEARCH.PRODUCT_CATEGORY.VALUE.SUB_CATEGORY ? "3px solid #a68242" : "3px"}`}}/>

                                          <div style={{width:"20px", minWidth:"20px", height:"2.5px", border:"none",
                                            backgroundColor:`${selectedSearch !== SEARCH.PRODUCT_CATEGORY.VALUE.SUB_CATEGORY ? "#a68242" : ""}`}}/>

                                          <div style={{height:"100%", position: "relative", display:"flex", justifyContent:"flex-start", alignItems:"center"}}>
                                            <div style={{zIndex:"1", borderRadius:"100%", border:"3px solid #a68242", padding:"2px", backgroundColor:"white"}}>
                                              <img
                                                  id="action-upload"
                                            ...
                                            { selectedCategoriesID.find((id) => id === subCategory.categoryID) &&
                                                ...
                                                <div style={{position:"absolute", zIndex:"0", alignSelf: "flex-end", width:"5px",
                                                  height:"calc(50% + 1.5px)", borderRight:"3px solid #a68242",
                                                  marginLeft:"25px"}}/>
                                            }
                                          </div>
                                                    ...
                                                    <div className={`${selectedSearch !== SEARCH.PRODUCT_CATEGORY.VALUE.SUB_CATEGORY ? "product-field" : "search-product-field"}`}>
                                                      <div style={{display:"flex", justifyContent:"flex-start", alignItems:"center", width: "100%", height:"100%"}}>
                                                        ...
                                                        <div style={{alignSelf: "flex-start", width:"25px", minWidth:"25px", height:"100%",
                                                          borderRight:`${subCategoryIndex !== category.subCategories.length - 1 && selectedSearch !== SEARCH.PRODUCT_CATEGORY.VALUE.SUB_CATEGORY  ? "3px solid #a68242":"3px"}`}}/>

                                                        <div style={{alignSelf: "flex-start", width:"25px", minWidth:"25px",
                                                          height:`${productIndex !== subCategory.products.length - 1 ? "100%" : "calc(50% + 1.5px)"}`, borderRight:"3px solid #a68242",
                                                          marginLeft:"25px"}}/>

                                                        <div style={{width:"20px", minWidth:"20px", height:"2.5px", backgroundColor:"#a68242", border:"none"}}/>
                                                  ...
                                                  <div className={`${selectedSearch !== SEARCH.PRODUCT_CATEGORY.VALUE.SUB_CATEGORY ? "product-field" : "search-product-field"}`}>
                                                    <div style={{display:"flex", justifyContent:"flex-start", alignItems:"center", width: "100%", height:"100%"}}>
                                                      ...
                                                      <div style={{alignSelf: "flex-start", width:"25px",
                                                        height:"calc(50% + 1.5px)", borderRight:"3px solid #a68242", marginLeft:"25px"}}/>

                                                      <div style={{width:"30px", height:"2.5px", backgroundColor:"#a68242", border:"none"}}/>
                                                      <a style={{cursor: "default", marginLeft:"15px", fontSize:"15", fontWeight:"600", color:"#a68242"}}>
      ...
      <div id="app">
            ...
            <div className="modal-overlay">
              <ConfirmDialog title={<span style={{color:"#a68242"}}>{CONFIRM_DIALOG.WARNING_TITLE}</span>}
                             subTitle={deletedCategory.type === CATEGORY.PARENT_CATEGORY ?
                                 (
                                     <>
                                       {CONFIRM_DIALOG.CONFIRM_DELETE_CATEGORY_SUBTITLE_1} <span style={{color:"#a68242"}}>{deletedCategory.categoryName}</span> {CONFIRM_DIALOG.CONFIRM_DELETE_CATEGORY_SUBTITLE_2} <br />
        ...
        {deletedProduct && (
            <div className="modal-overlay">
              <ConfirmDialog title={<span style={{color:"#a68242"}}>{CONFIRM_DIALOG.WARNING_TITLE}</span>}
                             subTitle={ <>
                               {CONFIRM_DIALOG.CONFIRM_DELETE_PRODUCT_SUBTITLE_1} <span style={{color:"#a68242"}}>{deletedProduct.productName}</span> {CONFIRM_DIALOG.CONFIRM_DELETE_PRODUCT_SUBTITLE_2} <br />
                             </>
                             }
                             titleBtnAccept={CONFIRM_DIALOG.DELETE_TITLE_BTN_ACCEPT}
                             titleBtnCancel={CONFIRM_DIALOG.CANCEL_TITLE_BTN_CANCEL}
