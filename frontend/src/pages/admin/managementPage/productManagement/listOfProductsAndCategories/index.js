...
const ListOfProductsAndCategoriesPage = () => {
  ...
  const [selectedSearch, setSelectedSearch] = useState(
    SEARCH.PRODUCT_CATEGORY.VALUE.CATEGORY
  );
  const [productDisplayQuantity, setProductDisplayQuantity] = useState(
    SELECT.DISPLAY_QUANTITY.VALUE.FIVE
  );
        ...
        let newData = data.map((category) => ({
          ...
          subCategories: category.subCategories.map((subCategory) => {
            ...
            return {
              ...
              products:
                matchedSubCategory &&
                matchedSubCategory.products &&
                matchedSubCategory.products.length > 0
                  ? matchedSubCategory.products
    ...
    try {
      ...
      if (response.ok) {
        ...
        const newCategoriesImgID = categoriesImgID.map((imgID) => {
          return imgID.categoryID === categoryID
            ? {
                ...imgID,
                imageFile: imageFile,
  ...
  const handleCategoryClick = (categoryID, type) => {
    if (selectedCategoriesID.includes(categoryID)) {
      const updatedCategoriesID = selectedCategoriesID.filter(
        (id) => id !== categoryID
      );
          ...
          newCategories
            .map((category) => ({
              ...
              subCategories: category.subCategories.filter(
                (subCategory) =>
                  subCategory.categoryID !== deletedCategory.categoryID
              ),
            }))
            .filter(
        ...
        fetchData().then((r) => {
          setCategories((newCategories) =>
            newCategories.filter((category) =>
              isSubstringIgnoreCaseAndAccents(
                searchInputValue,
      ...
      <div>
        
        {
          <section>
            <div
              style={{
                boxShadow: "1px 1px 4px 0 rgba(0, 0, 0, 0.102)",
                overflow: "hidden",
                borderRadius: "3px",
            ...
            >
              {categories.map((category, index) => (
                <div key={index}>
                  {selectedSearch !==
                    SEARCH.PRODUCT_CATEGORY.VALUE.SUB_CATEGORY && (
                    <div
                      className={`pointer-cursor ${
                        selectedCategoriesID.find(
                      ...
                      <div style={{ display: "flex" }}>
                        ...
                        >
                          <div
                            ...
                            onClick={(e) =>
                              handleBtnAddCategoryClick(e, category.categoryID)
                            }
                          >
                            <IoAdd />
                          </div>
                              ...
                              <div style={{ display: "flex" }}>
                                ...
                                >
                                  <div
                                    ...
                                    onClick={() => {
                                      navigate(
                                        `/admin/management-page/add-product`,
                                        {
                                          state: {
                                            category: category,
                                      ...
                                      <div key={productIndex}>
                                        ...
                                        >
                                          ...
                                          <div style={{ display: "flex" }}>
                                            ...
                                            >
                                              <div
                                                className="pointer-cursor btn-category"
                                                style={{ marginRight: "20px" }}
                                                onClick={(e) =>
                                                  handleBtnDeleteProductClick(
                                                    e,
                                                    product.productID,
                                                    product.productName
                                                  )
                                            ...
                                            >
                                              <a>
                                                <div
                                                  ...
                                                  onClick={() => {
                                                    navigate(
                                                      `/admin/management-page/edit-product?productID=${product.productID}`
                                                    );
                                                  }}
                                                >
                                                  <BiSolidEdit />
      ...
      <section>
        ...
        >
          <div>
            {productsData &&
              productsData
                .slice(0, productDisplayQuantity)
  ...
  return (
    <div id="app">
      <main id="main">
        ...
        <div
          className="container pe-0 ps-0"
          style={{ paddingBottom: "100px", minWidth: "800px" }}
        >
          <div style={{ margin: "0 70px 0 40px" }}>
            ...
            >
              ...
              <button
                type="button"
                className="add-parent-category-btn"
                onClick={(e) =>
                  handleBtnAddCategoryClick(e, ROOT_PARENT_CATEGORY_ID)
                }
              >
                <HiPlus
                  style={{
                ...
                <span style={{ marginRight: "5px" }}>
                  {LIST_OF_PRODUCTS_AND_CATEGORIES_PAGE.ADD_PARENT_CATEGORY}
                </span>
              </button>
            </p>
            <div
                ...
                >
                  ...
                  >
                    <Select
                      ...
                      options={[
                        {
                          value: SEARCH.PRODUCT_CATEGORY.VALUE.CATEGORY,
                          label: SEARCH.PRODUCT_CATEGORY.LABEL.CATEGORY,
                        },
                        {
                          value: SEARCH.PRODUCT_CATEGORY.VALUE.SUB_CATEGORY,
                          label: SEARCH.PRODUCT_CATEGORY.LABEL.SUB_CATEGORY,
                        },
                        {
                          value: SEARCH.PRODUCT_CATEGORY.VALUE.PRODUCT,
                          label: SEARCH.PRODUCT_CATEGORY.LABEL.PRODUCT,
                        },
                      ]}
                      onChange={(value) => {
                ...
                >
                  ...
                  >
                    <input
                      ...
                      placeholder={
                        LIST_OF_PRODUCTS_AND_CATEGORIES_PAGE.SEARCH_KEYWORD_PLACEHOLDER
                      }
                      onChange={(e) => {
                  ...
                  >
                    ...
                    >
                      <span style={{ marginBottom: "1px" }}>
                        {LIST_OF_PRODUCTS_AND_CATEGORIES_PAGE.DISPLAY_QUANTITY}
                      </span>
                      <ConfigProvider
                        theme={{
                          components: {
                      ...
                      >
                        <Select
                          ...
                          options={[
                            {
                              value: SELECT.DISPLAY_QUANTITY.VALUE.FIVE,
                              label: SELECT.DISPLAY_QUANTITY.LABEL.FIVE,
                            },
                            {
                              value: SELECT.DISPLAY_QUANTITY.VALUE.TEN,
                              label: SELECT.DISPLAY_QUANTITY.LABEL.TEN,
                            },
                            {
                              value: SELECT.DISPLAY_QUANTITY.VALUE.FIFTY,
                              label: SELECT.DISPLAY_QUANTITY.LABEL.FIFTY,
                            },
                            {
                              value: SELECT.DISPLAY_QUANTITY.VALUE.HUNDRED,
                              label: SELECT.DISPLAY_QUANTITY.LABEL.HUNDRED,
                            },
                            {
                              value:
                                SELECT.DISPLAY_QUANTITY.VALUE.ONE_HUNDRED_FIFTY,
                              label:
                                SELECT.DISPLAY_QUANTITY.LABEL.ONE_HUNDRED_FIFTY,
                            },
                            {
                              value: SELECT.DISPLAY_QUANTITY.VALUE.TWO_HUNDRED,
                              label: SELECT.DISPLAY_QUANTITY.LABEL.TWO_HUNDRED,
                            },
                          ]}
      ...
      {deletedCategory && (
        <div className="modal-overlay">
          <ConfirmDialog
            title={
              <span style={{ color: "#a68242" }}>
                {CONFIRM_DIALOG.WARNING_TITLE}
              </span>
            }
            subTitle={
              deletedCategory.type === CATEGORY.PARENT_CATEGORY ? (
                <>
                  {CONFIRM_DIALOG.CONFIRM_DELETE_CATEGORY_SUBTITLE_1}{" "}
                  <span style={{ color: "#a68242" }}>
                    {deletedCategory.categoryName}
                  </span>{" "}
                  {CONFIRM_DIALOG.CONFIRM_DELETE_CATEGORY_SUBTITLE_2} <br />
      ...
      {deletedProduct && (
        <div className="modal-overlay">
          <ConfirmDialog
            ...
            subTitle={
              <>
                {CONFIRM_DIALOG.CONFIRM_DELETE_PRODUCT_SUBTITLE_1}{" "}
                <span style={{ color: "#a68242" }}>
                  {deletedProduct.productName}
                </span>{" "}
                {CONFIRM_DIALOG.CONFIRM_DELETE_PRODUCT_SUBTITLE_2} <br />
              </>
            }
            titleBtnAccept={CONFIRM_DIALOG.DELETE_TITLE_BTN_ACCEPT}
            titleBtnCancel={CONFIRM_DIALOG.CANCEL_TITLE_BTN_CANCEL}
      ...
      {addingCategory && (
        <div className="modal-overlay">
          <AddCategoryDialog
            parentCategoryID={addingCategory.parentCategoryID}
