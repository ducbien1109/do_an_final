...
public class PaymentController {
    ...
    private final String ORDER_STATUS_PENDING = "Hoàn thành";
...
public ResponseEntity<?> createPayment(HttpServletRequest request) throws UnsupportedEncodingException {
    ...
    OrderDetails orderDetails = new OrderDetails(orders.getOrderID(), product.getProductID(),
            ...
            String.valueOf(product.getProductImages().get(0).getImagePath()), String.valueOf(product.getProductSizes()), product.getProductPrice(), quantityPurchase,
