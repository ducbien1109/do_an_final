                        ...
                        <div key={index}>
                          {editingCategoryID && category.categoryID === editingCategoryID ?
                            <li data-v-38ab3376="" className="category-item" style={{background:"white"}}>
                              <div data-v-38ab3376="" className="text-overflow">
                                <input className="input-category"
                                       style={{borderBottom: "1px solid #a68242"}}
                                       type="text" ref={inputCategoryRef}
                                       value={inputValue}
                                       onChange={(e) => setInputValue(e.target.value)}
                                />
                              ...
                              <div data-v-38ab3376="" className="category-item-right">
                                <MdOutlineClose onClick={(e) => handleCancelCategoryClick(e)} className="btn-add pointer-cursor" style={{marginRight:"5px", color:"#a68242"}}/>
                                <BsCheckLg onClick={() => handleSaveEditCategoryClick(category.categoryID)} className="btn-add pointer-cursor"  style={{color:"#a68242"}}/>
                              </div>
                            </li>
                            :
                          ...
                          <div key={index}>
                            {editingCategoryID && subCategory.categoryID === editingCategoryID ?
                              <li data-v-38ab3376="" className="category-item" style={{background:"white"}}>
                                ...
                                <div data-v-38ab3376="" className="category-item-right">
                                  <MdOutlineClose onClick={(e) => handleCancelCategoryClick(e)} className="btn-add pointer-cursor" style={{marginRight:"5px", color:"#a68242"}}/>
                                  <BsCheckLg onClick={() => handleSaveEditCategoryClick(subCategory.categoryID)} className="btn-add pointer-cursor"  style={{color:"#a68242"}}/>
                                </div>
                              </li>
                              :
