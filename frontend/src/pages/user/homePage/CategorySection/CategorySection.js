            ...
            <div className="image-wrap__img position-absolute w-100">
              ...
              <img
                style={{
                  ...
                  objectFit:
                    "cover" /* Đảm bảo hình ảnh được hiển thị đúng tỷ lệ */,
                }}
                lazy-src={category.imagePath}
                alt={`Icon danh mục SP 400 x 400 px_${category.categoryName}`}
                loading="lazy"
...
const CategorySection = () => {
  ...
  const handleNextClick = () => {
    setCurrentSlide(
      Math.min(
        Math.max(0, categoryItem.length - maxCategoriesPerPage),
        currentSlide + maxCategoriesPerPage
      )
    );
  };
      ...
      <div className="category-wrap">
        <div className="title">
          <p className="text-center mb-0">
            {HOME_PAGE.PRODUCT_CATEGORIES_TITLE}
          </p>
        </div>
        <div
          className="content owl-carousel owl-theme owl-loaded owl-drag"
          id="content-category"
        >
          <div className="owl-stage-outer">
            <div
              className="owl-stage"
              style={{
                transform: `translate3d(-${currentSlide * 119}px, 0px, 0px)`,
          ...
          <div className="owl-nav">
            ...
            <button
              ...
              role="presentation"
              className={`owl-next ${
                currentSlide === categoryItem.length - maxCategoriesPerPage + 1
                  ? "hide"
                  : ""
              }`}
