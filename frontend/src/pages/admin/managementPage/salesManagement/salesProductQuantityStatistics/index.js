              ...
              productsData.slice(0, productDisplayQuantity).map((product, productIndex) => (
                <div key={productIndex} style={{ borderBottom: "1px solid #E4E4E4" }}>
                  <div className={"product-field"} style={{ justifyContent: "flex-start" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "flex-start", alignItems: "center", width: "20%", height: "100%" }}>
                      <span style={{ margin: "8px 0 0 10px", color: "#a68242", fontWeight: "600" }}>
                        {SALES_PRODUCT_QUANTITY_STATISTICS_PAGE.PRICE}: {product.productPrice * product.quantitySold}
                      </span>
                    </div>
      ...
      <main id="main">
        ...
        <div className="container pe-0 ps-0" style={{ paddingBottom: "100px", minWidth: "800px" }}>
          <div style={{ margin: "0 70px 0 40px" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", height: "100%", paddingLeft: "35px" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginRight: "35px" }}>
                  <div style={{ display: "flex", alignItems: "center", height: "35px", borderBottom: "2px solid #a68242" }}>
                    ...
                    />
                    <IoSearch style={{ color: "#a68242", padding: "0px 0 0px", fontSize: "20px", marginRight: "10px" }} className="pointer-cursor" />
                  </div>
                </div>
            ...
            <div style={{
              boxShadow: "1px 1px 4px 0 rgba(0, 0, 0, 0.102)", marginBottom: "10px",
