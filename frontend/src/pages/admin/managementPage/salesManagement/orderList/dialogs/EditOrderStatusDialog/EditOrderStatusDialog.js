    ...
    >
      <div className="modal-dialog modal-dialog-centered">
        <div
          ...
          style={{ color: "#333333", padding: "30px", width: "550px" }}
        >
          <div style={{ marginBottom: "13px" }}>
            <MdOutlineEditNote
              style={{ fontSize: "30px", margin: "0 7px 5px 0" }}
            />
            <span style={{ fontSize: "20px", fontWeight: "900" }}>
              {ORDER_LIST_PAGE.EDIT_ORDER_STATUS}
            </span>
          </div>
          <div data-v-38ab3376="" className="text-overflow select-order-status">
            ...
            >
              <Select
                ...
                options={[
                  {
                    value: TAB_LIST_TEXT.PENDING_CONFIRMATION,
                    label: TAB_LIST_TEXT.PENDING_CONFIRMATION,
                  },
                  {
                    value: TAB_LIST_TEXT.CONFIRMED,
                    label: TAB_LIST_TEXT.CONFIRMED,
                  },
                  {
                    value: TAB_LIST_TEXT.IN_TRANSIT,
                    label: TAB_LIST_TEXT.IN_TRANSIT,
                  },
                  {
                    value: TAB_LIST_TEXT.COMPLETED,
                    label: TAB_LIST_TEXT.COMPLETED,
                  },
                  {
                    value: TAB_LIST_TEXT.CANCELLED,
                    label: TAB_LIST_TEXT.CANCELLED,
                  },
                ]}
                onChange={(value) => {
          ...
          <div className="button-container" style={{ marginTop: "40px" }}>
            <button
              type="button"
              className="add-category-dialog-btn"
              onClick={handleEditOrderStatus}
            >
              {ORDER_LIST_PAGE.SAVE_BTN}
            </button>
            <button
              type="button"
              className="add-category-dialog-btn add-category-dialog-btn-cancel"
              onClick={onClose}
            >
              {ORDER_LIST_PAGE.CANCEL_BTN}
            </button>
          </div>
        </div>
      </div>
