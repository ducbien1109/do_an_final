...
const LoginDialog = ({ onClose, onSwitch }) => {
  ...
  const apiForgotPasswordUrl = API.PUBLIC.FORGOT_PASSWORD;
  ...
  const handleForgotPassword = async () => {
    ...
    try {
      const response = await fetch(apiForgotPasswordUrl, {
        method: "POST",
        body: formData,
        // headers: {
      ...
      setMessage(ERROR.SERVER_CONNECTION_ERROR);
    }
  };
      ...
      if (response.status === 200) {
        ...
        response.text().then((data) => {
          ...
          const errorText = document.querySelector(
            ".text-danger.error-text.password-error"
          );
        ...
        >
          <div className="modal-content">
            <div className="modal-body">
              ...
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEiKhSsLG9LhQ3sdYUrJJGLGiudB5gWX_1fQ&s"
                style={{ width: "70px" }}
              />
                ...
                >
                  ...
                  <div className="tool-wrap">
                    <span
                      ...
                      style={{ fontSize: "13px", color: "#a68242" }}
                      onClick={() => {
